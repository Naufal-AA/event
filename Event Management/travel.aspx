<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="travel.aspx.cs" Inherits="Event_Management.WebForm55" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table>
        <tr>
            <td style="width: 100px" height="50">
            </td>
            <td style="width: 100px" height="50">
            </td>
            <td style="width: 100px" height="50">
        ...
        <tr>
            ...
            <td style="width: 100px">
                <asp:Panel ID="Panel1" runat="server" Visible="False">
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:Button ID="Button1" runat="server"
                        Font-Bold="True" Font-Names="Times New Roman" OnClick="Button1_Click" Text="VIEW" /></asp:Panel>
            </td>
            <td style="width: 100px">
            </td>
            <td style="width: 100px">
            ...
            <td style="width: 100px">
                <asp:Panel ID="Panel2" runat="server" Visible="False">
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:Button ID="Button2" runat="server"
                        Font-Bold="True" Font-Names="Times New Roman" OnClick="Button2_Click" Text="VIEW" /></asp:Panel>
            </td>
            <td style="width: 100px">
            </td>
            <td style="width: 100px">
            ...
            <td style="width: 100px">
                <asp:Panel ID="Panel3" runat="server" Font-Bold="True" Font-Names="Times New Roman" Visible="False">
                    <table>
                        <tr>
                            <td style="width: 100px">
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:Button ID="Button3" runat="server"
                        Font-Bold="True" Font-Names="Times New Roman" OnClick="Button3_Click" Text="VIEW" /></asp:Panel>
            </td>
            <td style="width: 100px">
            </td>
            <td style="width: 100px">
            ...
            <td style="width: 100px">
                <asp:Panel ID="Panel4" runat="server" Visible="False">
                    <table>
                        <tr>
                            <td style="width: 100px">
                                <asp:Image ID="Image4" runat="server" Height="220px" Width="210px" />
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 100px; height: 24px">
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:Button ID="Button4" runat="server"
                        Font-Bold="True" Font-Names="Times New Roman" OnClick="Button4_Click" Text="VIEW" /></asp:Panel>
            </td>
            <td style="width: 100px">
            </td>
            <td style="width: 100px">
            ...
            <td style="width: 100px">
                <asp:Panel ID="Panel5" runat="server" Visible="False">
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:Button ID="Button5" runat="server"
                        Font-Bold="True" Font-Names="Times New Roman" OnClick="Button5_Click" Text="VIEW" /></asp:Panel>
            </td>
            <td style="width: 100px">
            </td>
            <td style="width: 100px">
            ...
            <td style="width: 100px">
                <asp:Panel ID="Panel6" runat="server" Visible="False">
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:Button ID="Button6" runat="server"
                        Font-Bold="True" Font-Names="Times New Roman" OnClick="Button6_Click" Text="VIEW" /></asp:Panel>
            </td>
            <td style="width: 100px">
            </td>
            <td style="width: 100px">
