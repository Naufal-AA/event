<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="stills.aspx.cs" Inherits="Event_Management.WebForm52" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table>
        <tr>
            <td style="width: 100px" height="80">
            </td>
            <td style="width: 100px" height="80">
            </td>
            <td style="width: 100px" height="80">
            ...
            <td style="width: 100px">
                <asp:Panel ID="Panel1" runat="server" Visible="False">
                    <table>
                        <tr>
                            <td style="width: 100px">
                                <asp:Image ID="Image1" runat="server" Width="210px" Height="220px" /></td>
                        </tr>
                        <tr>
                            <td style="width: 100px">
                            </td>
            ...
            <td style="width: 100px">
                <asp:Panel ID="Panel2" runat="server" Visible="False">
                    <table>
                        <tr>
                            <td style="width: 100px">
                                <asp:Image ID="Image2" runat="server" Width="210px" Height="220px" /></td>
                        </tr>
                        <tr>
                            <td style="width: 100px">
                            </td>
