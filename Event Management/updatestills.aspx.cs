...
namespace Event_Management
{
    public partial class WebForm61 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            int a = 0;
            com = new SqlCommand();
            com.CommandText = "SELECT CamType,Duration,Price,Image from Stills where Itemcode=@Itemcode";
        ...
        {
            ccc = new SqlCommand();
            ccc.CommandText = "delete from Stills where Itemcode=@Itemcode";
            ...
            cmd.Parameters.Add("@CamType", DropDownList2.Text);
