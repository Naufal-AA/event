<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="dec.aspx.cs" Inherits="Event_Management.WebForm21" %>
            ...
            <td style="width: 100px">
                <asp:Panel ID="Panel1" runat="server" Visible="False">
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:Button ID="Button1" runat="server"
                        Text="VIEW" Font-Bold="True" Font-Names="Times New Roman" OnClick="Button1_Click" /></asp:Panel>
            </td>
            <td style="width: 100px">
            </td>
            <td style="width: 100px">
            ...
            <td style="width: 100px">
                <asp:Panel ID="Panel2" runat="server" Visible="False">
                    <table>
                        <tr>
                            <td style="width: 100px">
                                <asp:Image ID="Image2" runat="server" Height="220px" Width="220px" /></td>
                        </tr>
                        <tr>
                            <td style="width: 100px">
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:Button ID="Button2" runat="server"
                        Text="VIEW" Font-Bold="True" Font-Names="Times New Roman" OnClick="Button2_Click" /></asp:Panel>
            </td>
            <td style="width: 100px">
            </td>
            <td style="width: 100px">
            ...
            <td style="width: 100px">
                <asp:Panel ID="Panel3" runat="server" Visible="False">
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:Button ID="Button3" runat="server"
                        Text="VIEW" Font-Bold="True" Font-Names="Times New Roman" OnClick="Button3_Click" /></asp:Panel>
            </td>
            <td style="width: 100px">
            </td>
            <td style="width: 100px">
            ...
            <td style="width: 100px">
                <asp:Panel ID="Panel4" runat="server" Visible="False">
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:Button ID="Button4" runat="server"
                        Text="VIEW" Font-Bold="True" Font-Names="Times New Roman" OnClick="Button4_Click" Width="54px" /></asp:Panel>
            </td>
            <td style="width: 100px">
            </td>
            <td style="width: 100px">
            ...
            <td style="width: 100px">
                <asp:Panel ID="Panel5" runat="server" Visible="False">
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:Button ID="Button5" runat="server"
                        Text="VIEW" Font-Bold="True" Font-Names="Times New Roman" OnClick="Button5_Click" Width="56px" /></asp:Panel>
            </td>
            <td style="width: 100px">
            </td>
            <td style="width: 100px">
            ...
            <td style="width: 100px">
                <asp:Panel ID="Panel6" runat="server" Visible="False">
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:Button ID="Button6" runat="server"
                        Text="VIEW" Font-Bold="True" Font-Names="Times New Roman" OnClick="Button6_Click" Width="54px" /></asp:Panel>
            </td>
            <td style="width: 100px">
            </td>
            <td style="width: 100px">
