...
namespace Event_Management
{
    public partial class WebForm21 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            db = new mydb();
            com1 = new SqlCommand();
            com1.CommandText = "SELECT Itemcode,Pandaltype,Sqfeet,Price,Image,Noofchair,Description,Nooffans,Nooflights  FROM Decoration";
            ...
            if (c > 0)
            {
                TextBox8.Text = "" + dt.Rows[4][1].ToString().Trim();
            ...
            if (c > 0)
            {
                TextBox11.Text = "" + dt.Rows[4][1].ToString().Trim();
