<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="Event_Management.WebForm44" %>
        ...
        <td align="center">
            ...
            <table style="width:300px; height: 263px;" align="center">
              <tr style="width:300px;height:40px">
                    <th bgcolor="#FF6699" class="style4">
                        <br />
                    </th>
              </tr> 
              <tr>
                    ...
                    <table style="width:300px">
                        ...
                        <tr>
                            ...
                            <td align="left" class="style11">
                                &nbsp;<br />
                                &nbsp;
                                <asp:TextBox ID="TextBox3" cssclass="input" placeholder="Email"
                        ...
                        <tr>
                            ...
                            <td align="left" class="style11">
                                ...
                                <br />
&nbsp;
                                <asp:TextBox ID="TextBox4" cssclass="input" placeholder="Password" 
                        ...
                        <tr>
                            <td colspan="2" align="right" class="style13">
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:Button ID="Button2" runat="server" Height="40px" Text="Login" Width="125px" OnClick="Button2_Click" />
                                <br />
                            </td>
                        </tr>
                    </table>
