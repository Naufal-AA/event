...
namespace Event_Management
{
    public partial class WebForm55 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            db = new mydb();
            com1 = new SqlCommand();
            com1.CommandText = "SELECT ItemCode,Vehicle,Name,Price,Image,Bustype,Noofseats,Duration,Description  FROM Travel";
            //com1.Parameters.Add("@type", "" + gen.ftype);
            dt = db.gettable(com1);
            int c = dt.Rows.Count;
            if (c > 0)
            {
                TextBox9.Text = "" + dt.Rows[0][1].ToString().Trim();
            ...
            if (c > 0)
            {
                TextBox6.Text = "" + dt.Rows[3][1].ToString().Trim();
            ...
            if (c > 0)
            {
                TextBox10.Text = "" + dt.Rows[4][1].ToString().Trim();
                TextBox11.Text = "" + dt.Rows[4][3].ToString().Trim();
            ...
            if (c > 0)
            {
                TextBox8.Text = "" + dt.Rows[5][1].ToString().Trim();
                TextBox12.Text = "" + dt.Rows[5][3].ToString().Trim();
                Image6.ImageUrl = "" + dt.Rows[5][4].ToString().Trim();
                Panel6.Visible = true;
                c6 = "" + dt.Rows[5][0].ToString().Trim();
                t6 = "" + dt.Rows[5][1].ToString().Trim();
                d6 = "" + dt.Rows[5][2].ToString().Trim();
                p6 = "" + dt.Rows[5][3].ToString().Trim();
                i6 = "" + dt.Rows[5][4].ToString().Trim();
                c--;
            }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            gen.price = p1;
            gen.image = i1;
            Response.Redirect("./travel1.aspx");
        }
