...
namespace Event_Management
{
    public partial class WebForm3 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            db = new mydb();
            com1 = new SqlCommand();
            com1.CommandText = "SELECT ItemCode,CamType,Duration,Price,Image  FROM Video";
            ...
            if (c > 0)
            {
                ...
                TextBox6.Text = "" + dt.Rows[0][3].ToString().Trim();
            ...
            if (c > 0)
            {
                TextBox1.Text = "" + dt.Rows[1][1].ToString().Trim();
