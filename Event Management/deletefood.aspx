<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="deletefood.aspx.cs" Inherits="Event_Management.WebForm26" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table>
        <tr>
            ...
            <td style="width: 319px; height: 45px">
        ...
        <tr>
            ...
            <td style="width: 319px">
                ...
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:Button ID="Button2" runat="server" Font-Bold="True"
                    Font-Names="Times New Roman" Height="32px" OnClick="Button2_Click" Text="Delete"
                    Width="58px" /></td>
            <td style="width: 100px">
            </td>
            <td style="width: 100px">
